...
import { t as getGlobalHookRunner } from "./hook-runner-global-BvDdPqDN.js";
import { b as loadSessionStore } from "./store-jR_nVe0n.js";
...
import { t as callGatewayTool } from "./gateway-Cql8-Ml_.js";
...
import { d as stripMalformedXmlArgValueSuffixFromKeys, i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-BR0o1ZGQ.js";
...
import { t as sendMessage } from "./message-rKk0_Xp1.js";
...
import { a as DEFAULT_PENDING_MAX_OUTPUT, c as createApprovalSlug, f as resolveApprovalRunningNoticeMs, h as renderExecOutputText, i as DEFAULT_PATH, m as runExecProcess, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveExecTarget, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS, u as normalizeNotifyOutput } from "./bash-tools.exec-runtime-eb0qLMg7.js";
import { i as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-surface-DuZAIaPF.js";
import { u as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-D03cR9_H.js";
...
import { i as defaultExecAutoReviewer, t as createModelExecAutoReviewer } from "./exec-auto-reviewer-BhIiv15B.js";
...
async function analyzeNodeApprovalRequirement(params) {
	...
	return {
		...
		autoReviewArgv: autoReviewBindingEval.segments.length === 1 && (autoReviewBindingEval.segments[0]?.raw === void 0 || autoReviewBindingEval.segments[0].raw.trim() === autoReviewBindingCommand.trim()) ? autoReviewBindingEval.segments[0].argv : (autoReviewBindingEval.analysisOk && autoReviewBindingEval.segments.length > 1 ? autoReviewBindingEval.segments.flatMap((s) => s.argv ?? []) : void 0)
	};
}
//#endregion
